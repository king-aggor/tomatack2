...
router.get(
  "/wholesaler-available-produces",
  retailerController.getWholesalerAvailableProduces
);
...
router.get(
  "/purchase-requests",
  retailerController.getRetailerPurchaseRequests
);
...
router.get(
  "/available-produces",
  retailerController.getRetailerAvailableProduces
);
